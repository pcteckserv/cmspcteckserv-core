...
O selector de media é reutilizável noutros formulários administrativos através do componente:
...
O componente abre a biblioteca de media partilhada e permite escolher uma imagem existente ou carregar uma nova.
