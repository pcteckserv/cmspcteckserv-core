...
class CmsCoreServiceProvider extends ServiceProvider
{
    ...
    private function registerCorePermissions(): void
    {
        $this->app->make(PermissionRegistry::class)->register([
            ...
            'core.smtp.view' => ['label' => 'Ver configuração SMTP', 'group' => 'SMTP'],
            'core.smtp.update' => ['label' => 'Editar configuração SMTP', 'group' => 'SMTP'],
            'core.smtp.test' => ['label' => 'Enviar teste SMTP', 'group' => 'SMTP'],
            'core.laravel-commands.view' => ['label' => 'Ver comandos Laravel', 'group' => 'Comandos Laravel'],
            'core.laravel-commands.run' => ['label' => 'Executar comandos Laravel', 'group' => 'Comandos Laravel'],
            ...
            'maintenance.view' => ['label' => 'Ver modo de manutenção', 'group' => 'Manutenção'],
            'maintenance.configure' => ['label' => 'Configurar modo de manutenção', 'group' => 'Manutenção'],
            'maintenance.toggle' => ['label' => 'Ativar ou desativar manutenção', 'group' => 'Manutenção'],
            'maintenance.preview' => ['label' => 'Pré-visualizar manutenção', 'group' => 'Manutenção'],
            'maintenance.manage-access' => ['label' => 'Gerir acesso privado', 'group' => 'Manutenção'],
