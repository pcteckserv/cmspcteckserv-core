...
return [
    ...
    'site_options' => [
        ...
        'maintenance_logo_scale' => env('CMS_MAINTENANCE_LOGO_SCALE', 100),
        ...
        'maintenance_background_color' => env('CMS_MAINTENANCE_BACKGROUND_COLOR', '#111827'),
        'maintenance_text_color' => env('CMS_MAINTENANCE_TEXT_COLOR', '#F8FAFC'),
        'maintenance_accent_color' => env('CMS_MAINTENANCE_ACCENT_COLOR', '#D6A85F'),
        ...
        'seo_site_name' => env('CMS_SEO_SITE_NAME', env('CMS_SITE_TITLE', 'CMS PCTECK')),
        'seo_default_title' => env('CMS_SEO_DEFAULT_TITLE', env('CMS_SITE_TITLE', 'CMS PCTECK')),
        'seo_title_template' => env('CMS_SEO_TITLE_TEMPLATE', '{page_title} | {site_name}'),
        'seo_default_description' => env('CMS_SEO_DEFAULT_DESCRIPTION', env('CMS_SITE_DESCRIPTION', 'Site institucional gerido pelo CMS PCTECK.')),
        'seo_default_og_image' => env('CMS_SEO_DEFAULT_OG_IMAGE'),
        'seo_twitter_card' => env('CMS_SEO_TWITTER_CARD', 'summary_large_image'),
        'seo_default_robots_index' => env('CMS_SEO_DEFAULT_ROBOTS_INDEX', true),
        'seo_default_robots_follow' => env('CMS_SEO_DEFAULT_ROBOTS_FOLLOW', true),
        'seo_auto_canonical' => env('CMS_SEO_AUTO_CANONICAL', true),
        'seo_base_url' => env('CMS_SEO_BASE_URL', env('CMS_SITE_URL', env('APP_URL', 'https://cliente.exemplo.pt'))),
        'seo_organization_name' => env('CMS_SEO_ORGANIZATION_NAME', env('CMS_SITE_TITLE', 'CMS PCTECK')),
        'seo_organization_type' => env('CMS_SEO_ORGANIZATION_TYPE', 'Organization'),
        'seo_organization_logo' => env('CMS_SEO_ORGANIZATION_LOGO'),
        'seo_organization_phone' => env('CMS_SEO_ORGANIZATION_PHONE'),
        'seo_organization_email' => env('CMS_SEO_ORGANIZATION_EMAIL'),
        'seo_organization_address' => env('CMS_SEO_ORGANIZATION_ADDRESS'),
        'seo_social_profiles' => env('CMS_SEO_SOCIAL_PROFILES', ''),
        'seo_search_console_verification' => env('CMS_SEO_SEARCH_CONSOLE_VERIFICATION'),
        'seo_bing_verification' => env('CMS_SEO_BING_VERIFICATION'),
        'seo_generate_open_graph' => env('CMS_SEO_GENERATE_OPEN_GRAPH', true),
        'seo_generate_twitter_cards' => env('CMS_SEO_GENERATE_TWITTER_CARDS', true),
        'seo_generate_json_ld' => env('CMS_SEO_GENERATE_JSON_LD', true),
        'seo_generate_sitemap' => env('CMS_SEO_GENERATE_SITEMAP', true),
        'seo_generate_robots_txt' => env('CMS_SEO_GENERATE_ROBOTS_TXT', true),
        'seo_robots_allow' => env('CMS_SEO_ROBOTS_ALLOW', ''),
        'seo_robots_disallow' => env('CMS_SEO_ROBOTS_DISALLOW', ''),
        'seo_robots_sitemap_url' => env('CMS_SEO_ROBOTS_SITEMAP_URL'),
        'seo_robots_advanced' => env('CMS_SEO_ROBOTS_ADVANCED', ''),
    ],
